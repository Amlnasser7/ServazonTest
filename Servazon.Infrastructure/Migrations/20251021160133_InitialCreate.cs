        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkArea = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictedCategory = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ConfidenceScore = table.Column<double>(type: "float", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AI_ClassificationLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AI_ClassificationLogs_ServiceRequests_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AI_ClassificationLogs_RequestId",
                schema: "core",
                table: "AI_ClassificationLogs",
                column: "RequestId",
                unique: true);
